...
export default function HelpPageClient({ dictionary }: { dictionary: any }) {
  ...
  const categoryDefinitions = [
    { icon: <LifeBuoy size={24} />, gradient: "from-blue-50 to-green-100 dark:from-blue-900/20 dark:to-green-900/20", iconBg: "bg-gradient-to-br from-green-400 to-green-600", delay: 0 },
